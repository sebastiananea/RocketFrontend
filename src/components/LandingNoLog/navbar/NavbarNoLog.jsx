    ...
    return (
        <div className={props.isScrolling > 20 ? s.scrolling : s.navbar}>
                ...
                <div className={s.links}> 
                        ...
                        <Link  className={selected === "second" ? s.linkSelected : s.link} onClick={()=>setState("third")} to="second" smooth={true} duration={1000} offset={-63}>Manifiesto</Link>
                        <Link  className={selected === "third" ? s.linkSelected : s.link} onClick={()=>setState("third")} to="third" smooth={true} duration={1000} offset={-63}>Trabaja con Nosotros</Link>
